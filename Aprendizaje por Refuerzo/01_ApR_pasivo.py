"""
El Aprendizaje por Refuerzo Pasivo es una rama del aprendizaje automático que implica que 
un agente aprenda a realizar acciones óptimas en un entorno a través de la observación de 
ejemplos en lugar de interactuar activamente con el entorno.
En este ejemplo, se entrena al agente para encontrar el camino óptimo desde la posición 
inicial (0, 1) hasta el objetivo (4, 4) en un laberinto simple. El agente aprende de los 
ejemplos de estados y recompensas óptimas observadas en el entorno.
"""
import numpy as np
