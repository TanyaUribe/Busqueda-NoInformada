"""
Monte Carlo para Cadenas de Markov (MCMC) es una técnica utilizada para muestrear valores
de una distribución de probabilidad utilizando cadenas de Markov. Uno de los algoritmos 
MCMC más conocidos es el Método de Metropolis-Hastings. 
"""
